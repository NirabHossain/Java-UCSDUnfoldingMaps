...
public abstract class CommonMarker extends SimplePointMarker {
	...
	public CommonMarker(Location location) {super(location);}
	...
	public void setClicked(boolean state) {	clicked = state;}
	
	public void draw(PGraphics pg, float x, float y) {
		// For starter code just drawMaker(...)
		if (!hidden) {
			drawMarker(pg, x, y);
			if (selected)showTitle(pg, x, y);  // You will implement this in the subclasses
		}
	}
