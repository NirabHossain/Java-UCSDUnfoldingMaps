...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	private void colorDetermine(PGraphics pg) {
		...
		if(this.getDepth()<THRESHOLD_INTERMEDIATE)pg.fill(255,255,0);
		else if(this.getDepth()<THRESHOLD_DEEP)pg.fill(0,0,255);
		else pg.fill(255,0,0);
		
		if(getProperty("age").equals("Past Hour"))pg.fill(255,255,255);
	}
